...
public:
    ...
    Car(int id_, int idUser_, int angle_, int x_, int y_) : id(id_), idUser(idUser_), v(0), centerAngle(angle_){ carCentre.first = x_; carCentre.second = y_;}
